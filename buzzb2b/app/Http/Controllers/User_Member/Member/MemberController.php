...
use App\Exchange;
use App\Address, App\Image, App\Phone;
use Auth,\Session;
...
class MemberController extends Controller
{
	...
	$memberID = Session::get('MEMBER_ID');
        ...
        // dd($data['memberCategories']);


        // return view('user_member.member.memberDirectory', $data);   
        return view('user_member.member.directory.dashboard');   
    }
