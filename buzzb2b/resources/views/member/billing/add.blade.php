...
{!! Form::open(array('route'=>'member-payment-profile-store', 'id'=>'paymentForm', 'class'=>'form-validate','method'=>'post')) !!}
...
<!--	<div class="form-group">
	...
	<div class="row"></div>	
		...
		<a href="{{ URL::route('member-payment-profile') }}" class="btn btn-info pull-right">Back</a>
 </div>
{!! Form::close() !!}
<script>
