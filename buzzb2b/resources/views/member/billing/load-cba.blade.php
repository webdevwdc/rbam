...
<div class="row">
	...
	<div class="col-lg-2 col-md-3 col-sm-3">
		<a href="{{route('member-payment-profile-add')}}" class="btn btn-info" title="Add New"><i class="fa fa-plus"></i> Add New</a>
	</div>
</div>
@if($cardlist)
	
	
{!! Form::open(array('route'=>'member-load-cba-redirect', 'id'=>'paymentForm', 'class'=>'form-validate','method'=>'get')) !!}
