	...
	{{-- messages section end--}}
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="panel-title bariol-thin"><i class="fa fa-lock"></i> Category Type</h3>
                    </div>
                </div>
            </div>
	...
	<div class="row">
		<div class="col-md-12"><!-- password_confirmation text field -->
			<h4>Category Type Details</h4>
				...
				{!! Form::open(array('route'=>['admin_category_store'], 'id'=>'', 'class'=>'form-validate','method'=>'post')) !!}				
				<div class="group_1">
					...
					<div class="row">
						...
						<div class="col-md-6">		
							<div class="form-group">
								...
								{!! Form::text('name','',array('class' => 'form-control required','id'=>'','placeholder'=>'Enter Category type')) !!}
							</div>
						</div>
						<div class="col-md-6">
						    		<div class="form-group">
