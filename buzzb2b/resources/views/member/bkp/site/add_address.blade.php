	...
	<div class="row">
		<div class="col-md-12"><!-- password_confirmation text field -->
			...
			<h4>Address Details</h4>
				...
				{!! Form::open(array('route'=>['admin_exchange_address_store'], 'id'=>'', 'class'=>'form-validate','method'=>'post')) !!}				
				<div class="group_1">
				...
				<a href="{{ URL::route('admin_setting_address') }}" class="btn btn-info pull-right">Back</a>
				{!! Form::close() !!}
			</div>
