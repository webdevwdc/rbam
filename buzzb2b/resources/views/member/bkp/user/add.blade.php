...
<div class="row">
	...
	{{-- messages section end--}}
        ...
        <div class="panel panel-info">
		    ...
		    <li @if(in_array(Route::current()->getName(), array('users-setting','users-edit','users-create'))) {{ "class=active" }} @endif>
...
{!! Form::open(array('route'=>['users-save'], 'id'=>'', 'class'=>'form-validate_','method'=>'post')) !!}				
<div class="group_1">
...
<div class="col-md-8">
	...
	<div class="form-group">
		...
		<div class="col-sm-5 col-md-4 col-lg-3">
			{{ Form::select('phone_type_id', $phone, null, ['class' => 'form-control']) }}
		</div>
	</div>
...
<div class="col-md-8">
    <div class="row">
				...
				<a href="{{ URL::route('users-setting',[$member->id]) }}" class="btn btn-info pull-right">Back</a>
				{!! Form::close() !!}
			</div>
