				...
				<div class="row flip-container vertical" id="panel-card-lookup">
					...
					<div class="flipper">
						...
						<div id="panel-card-lookup-form" class="front">
							...
							<form method="POST" action="{{route('search-member-bartercard')}}">
							...
							<button type="button" id="submit-card-lookup-spinner" href="#" class="btn btn-default btn-lg btn-submit-form disabled hidden" role="button">
							<span class="glyphicon glyphicon-refresh glyphicon-refresh-animate " aria-hidden="true"></span>
							</button>

							<a  id="reset-card-lookup"  class="btn btn-default btn-lg btn-reset-form disabled clear">
