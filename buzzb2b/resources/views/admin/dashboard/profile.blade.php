    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="panel-title bariol-thin"><i class="fa fa-pencil"></i>{{ Session::get('EXCHANGE_CITY_NAME') }} : Change Password</h3>
                    </div>
                </div>
            </div>
...
<div class="col-md-12 col-xs-12">
				...
				<a href="{{ URL::route('admin-manage-account') }}" class="btn btn-info pull-right">Back</a>
				{!! Form::close() !!}
			</div>
