...
<div class="col-md-8">
	...
	<div class="form-group">
		...
		<div class="col-sm-5 col-md-5">
			{{ Form::select('create_new_user', [1 => 'Create New User', 2=> 'Select Existing User By Email'], null, ['class' => 'form-control']) }}
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-5 col-md-4 col-lg-5">
			{{ Form::text('display_phone_number', null, ['class' => 'form-control', 'id'=>'display_phone_number']) }}
		</div>
	</div>
		...
		<div class="col-sm-offset-4 col-sm-8">
			<div class="checkbox">
				<label>
					...
					<span id="isAdminSpan">{{ Form::checkbox('is_admin', 1, '', ['id' => 'is_admin']) }} This member is admin</span>
