                                    ...
                                    <thead>
                                      ...
                                      @foreach($phones as $phone)
                                          <tr>
                                              ...
                                              <td>
                                                <a href="{!! URL::route('admin_phone_edit', ['id' => $phone->id]) !!}" title="Edit Phone Number"><i class="fa fa-pencil-square-o fa-2x"></i></a>
						                                    @if($phone->is_primary == 'No')
                                                <a href="{!! URL::route('admin_phone_delete',['id' => $phone->id, '_token' => csrf_token()]) !!}" class="margin-left-5 delete" title="Delete Phone Number" onclick="return confirm('Are you want to delete this phone?')"><i class="fa fa-trash-o fa-2x"></i></a>
						                                   @endif
                                              </td>
                                          </tr>
                                      </tbody>
