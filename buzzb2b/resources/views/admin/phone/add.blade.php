	...
	<div class="row">
		<div class="col-md-12"><!-- password_confirmation text field -->
			<h4>Phone Number Details</h4>
				...
				{!! Form::open(array('route'=>['admin_phone_store'], 'id'=>'', 'class'=>'form-validate','method'=>'post')) !!}				
				<div class="group_1">
					...
					<div class="row">
						...
						<div class="col-md-6">		
							<div class="form-group">
								...
								{!! Form::text('phone_number','',array('class' => 'form-control required','placeholder'=>'Enter phone number')) !!}
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
