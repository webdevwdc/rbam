...
@extends('admin.directory.layouts.base-2cols')
@section('content')
        ...
        <div class="col-xs-12 col-lg-7" style="margin-top:20px;">
            <div class="input-group">
                ...
                <span class="input-group-btn" onclick="callingAgainstCheckBox()">
                    <button id="submit-directory-exchange-search" class="btn btn-default btn-lg btn-search" type="submit" title="Search">
			<span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                    </button>
		    <a href="{{route('directory')}}" class="btn btn-default search-reset directoryResetBtn" title="Reset"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                </span>
            </div>
        </div>
    </div>
